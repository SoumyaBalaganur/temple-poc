...
@Component({
  selector: 'app-team-wise-chart',
  templateUrl: './team-wise-chart.component.html',
  styleUrls: ['./team-wise-chart.component.css']
})
export class TeamWiseChartComponent implements OnInit {

  constructor() { }

  convertData(data: any[]) {
    const uniqueCategories = Array.from(new Set(data.map(item => item["GPM Team"])));
  ...
  ngOnInit() {
    ...
    Highcharts.chart("team-wise", this.options);
  }
